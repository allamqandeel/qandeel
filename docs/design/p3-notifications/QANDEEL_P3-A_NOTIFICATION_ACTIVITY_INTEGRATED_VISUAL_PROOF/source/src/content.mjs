...
//
//   APPROVED   the Product Owner's exact accepted name / wording (task §5–§12)
...
export const COPY = {
  ar: {
    ...
    introHelp: s('على شاشة القفل لن يظهر أن الإشعار عن التعارف.', P, 'D15'),
    ...
    quietHelp: s('خلالها لا يصلك إلا تذكير طلبته لوقت محدد أو تنبيه أمان مهم. وما ينتظر يُراجَع صباحًا، ولا يصل دفعة واحدة.', P, 'D06; P3-M'),
    ...
    levels: { L0: s('خاصة جدًا', D, 'task §10'), L1: s('تنبيه عام', O, 'no directional word for L1 was given'), L2: s('إظهار السياق', D, 'task §10'), L3: s('إظهار المعاينة', D, 'task §10') },
  ...
  en: {
    ...
    stripRegion: s('Notice', P), stripDismiss: s('Dismiss', P),
    ...
    introHelp: s('On the Lock Screen, it won\'t show that a notification is about Introductions.', P, 'D15'),
    ...
    levels: { L0: s('Very private', P), L1: s('General', O), L2: s('Show context', P), L3: s('Show preview', P) },
