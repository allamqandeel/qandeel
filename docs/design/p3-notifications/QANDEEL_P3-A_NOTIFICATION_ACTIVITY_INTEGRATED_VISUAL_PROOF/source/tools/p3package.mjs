...
const manifest = { package: NAME, status: 'P3-A FINAL MICRO-REFINEMENT — READY FOR PRODUCT OWNER + INDEPENDENT REVIEW — P3 remains NOT CLOSED / NOT FROZEN — no production runtime',
