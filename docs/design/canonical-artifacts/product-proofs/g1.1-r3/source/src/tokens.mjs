...
const ROLE_PATHS = {
  ...
  // R3: the reader's conversational slab. It is resolved from the ONE functional Surface tone directly,
  // not through a role alias, because no frozen B4 role truthfully owns it (G1.1_R3_B4_RECONCILIATION_NOTE):
  // borrowing apparatus.fill would claim the slab is machinery. Same value, no new colour.
  functional: 'qandeel.surface.functional',
