...
<title>QANDEEL — I-08B3.1-G3.2 targeted coherence refinement proof</title>
...
<h1>QANDEEL · I-08B3.1-G3.2 — targeted coherence refinement proof</h1>
<p>G3.1's one Product state machine, refined for two Product Owner decisions under proof: <b>D-A</b> the Analysis shell stays dark with the Living Analysis World under system Light and Dark; <b>D-B</b> the concise temporal orientation line sits directly above the Timeline. Everything in the phone is Product; everything here simulates the device, the other human, or jumps to a start state. World: <code id="sha-state">verifying…</code></p>
<h2>Start states</h2>
...
<h2 class="open">D-A under proof — no shell switch exists</h2>
<p>Under system Light the Analysis — world, status region, upper chrome, Timeline, OrientationChrome, call line, rail — is one dark place; the Conversation, the private proposal and the Shared World follow the system. The Living Analysis World itself is identical under Dark and Light.</p>
<h2>Truth</h2>
