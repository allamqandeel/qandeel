...
// G2.2 reuses the G2.1 package's vendored token tree, read-only (not copied, not edited).
const TOKENS = join('E:/QANDEEL/QANDEEL PROJECT/design-workshops/I-08B3.1-G2.1-ANALYSIS-SCREEN-COMPOSITION/source/vendor', 'tokens');
