...
const event=(overrides:Partial<RuntimeEventEnvelope>={}):RuntimeEventEnvelope=>({event_id:IDS.event,event_type:'ConversationTurnCompleted',event_version:'1.0',occurred_at:'2026-01-01T00:00:00Z',producer:'conversation-service',subject_user_id:IDS.user,subject_session_id:IDS.session,subject_turn_id:IDS.turn,correlation_id:null,causation_id:null,classification:'SENSITIVE',schema_ref:'qandeel.runtime.conversation-turn-completed.v1',payload:{user_id:IDS.user,session_id:IDS.session,source_turn_id:IDS.turn,terminal_status:'COMPLETED',processing_path:'FAST',routing_reason:'FAST_DEFAULT',orchestration_id:null},contains_content:false,retention_class:'OPERATIONAL_EVENT_V1',...overrides});
