...
@Module({ imports: [MemoryModule], providers: [HimDefinitionRegistry, HimRepository, HimService, HimCalculationModelRegistry, HimCalculationService, HimIntelligenceSnapshotService, HimReasoningConsumptionService, HimTurnContextSelectionService, HimFastDeepConsumptionService, HimInteractionAdaptationService, HimContextualCurrentIntelligenceService, HimSessionReflectionConsumptionService, HimSessionContextBindingRepository, HimSessionContextBindingService, HimSituationStressRepository, HimSituationStressConsumptionService, HimDecisionAttentionRepository, HimDecisionAttentionConsumptionService], exports: [HimDefinitionRegistry, HimRepository, HimService, HimCalculationModelRegistry, HimCalculationService, HimIntelligenceSnapshotService, HimReasoningConsumptionService, HimTurnContextSelectionService, HimFastDeepConsumptionService, HimInteractionAdaptationService, HimContextualCurrentIntelligenceService, HimSessionReflectionConsumptionService, HimSessionContextBindingRepository, HimSessionContextBindingService, HimSituationStressRepository, HimSituationStressConsumptionService, HimDecisionAttentionRepository, HimDecisionAttentionConsumptionService] })
