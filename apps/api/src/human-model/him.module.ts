...
// QHIA-009: the cross-context foreground aggregate transport. The direct
// QHIA-007 and QHIA-008 boundaries above stay registered and exported
// unchanged - they remain canonical, independently callable authorities; the
// aggregate only replaces how the Conversation Orchestrator reaches them.
...
@Module({ imports: [MemoryModule], providers: [HimDefinitionRegistry, HimRepository, HimService, HimCalculationModelRegistry, HimCalculationService, HimIntelligenceSnapshotService, HimReasoningConsumptionService, HimTurnContextSelectionService, HimFastDeepConsumptionService, HimInteractionAdaptationService, HimContextualCurrentIntelligenceService, HimSessionReflectionConsumptionService, HimSessionContextBindingRepository, HimSessionContextBindingService, HimSituationStressRepository, HimSituationStressConsumptionService, HimDecisionAttentionRepository, HimDecisionAttentionConsumptionService, HimCrossContextForegroundRepository, HimCrossContextForegroundAggregationService], exports: [HimDefinitionRegistry, HimRepository, HimService, HimCalculationModelRegistry, HimCalculationService, HimIntelligenceSnapshotService, HimReasoningConsumptionService, HimTurnContextSelectionService, HimFastDeepConsumptionService, HimInteractionAdaptationService, HimContextualCurrentIntelligenceService, HimSessionReflectionConsumptionService, HimSessionContextBindingRepository, HimSessionContextBindingService, HimSituationStressRepository, HimSituationStressConsumptionService, HimDecisionAttentionRepository, HimDecisionAttentionConsumptionService, HimCrossContextForegroundRepository, HimCrossContextForegroundAggregationService] })
