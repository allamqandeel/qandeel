...
// QHIA-009/QHIA-010: the cross-context foreground aggregate transport. The
// direct QHIA-007, QHIA-008 and QHIA-010 boundaries above stay registered and
// exported unchanged - they remain canonical, independently callable
// authorities; the aggregate only replaces how the Conversation Orchestrator
// reaches them.
