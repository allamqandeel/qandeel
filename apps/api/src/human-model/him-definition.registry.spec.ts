...
describe('Initial HIM catalog',()=>{
  ...
  it('activates only Energy and Motivation while leaving 15 metrics uncalibrated',()=>{
    ...
    INITIAL_HIM_METRICS.filter(x=>!['hse.energy','hse.motivation'].includes(x.metricKey)).forEach(x=>{
