...
try{
 ...
 const binding=await client.query("SELECT count(*)::int n FROM public.him_canonical_model_bindings WHERE status='ACTIVE' AND metric_key='hse.energy' AND definition_version=1 AND context_kind='CONVERSATION_SESSION'");
