...
| [`docs/canonical-authority/`](docs/canonical-authority/README.md) | recovered upstream authority: Experience Architecture Stages 0–6 and Connected Worlds v2 CW2-00 … CW2-08. **Historical / upstream, not the entry point** |
| [`docs/design/`](docs/design/) | design-track records: `phase-v/`, `phase-vi/`, and the I-08B3.1-G closures in `i-08b3.1-g1.1/`, `i-08b3.1-g1.2/`, `i-08b3.1-g2/`, `i-08b3.1-g2.3/` and `i-08b3.1-g3/` |
...
| Voice / Live Call | [`docs/design/i-08b3.1-g1.2/QANDEEL_G1_2_CANONICAL_CLOSURE.md`](docs/design/i-08b3.1-g1.2/QANDEEL_G1_2_CANONICAL_CLOSURE.md) (Product) | `QAN-BL-VOICE-01` (no runtime exists) |
...
| `I-08B…` design-track identifiers | the same `I-08` prefix as the Connected Worlds phase | `I-08B3.1-G3` "is a design-track identifier, not Connected Worlds phase `I-08`" (G2 and G3 closures) |
